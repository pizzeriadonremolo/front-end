   ...
   <div>
    ...
    <form onSubmit={handleSubmit} >
        ...
        </select>
        {
          pago === 'efectivo'?
          (
            <input className={style.inputs} placeholder="Con cuanto abonaras?" style={error.pago?({border:'2px solid red'}): null}  name="pago" value={orderData.pago} onChange={handleInputChange} />
          )
          :(
            null
          )
